...
namespace SmartFoxClientAPI
{
    ...
    public class SFSEvent {
         ...
         * 	</example>
         * 
         * <seealso cref="SmartFoxClient.CreateRoom(Hashtable, int)"/>
         * 
         * <remarks>
         * <para><b>Version:</b><br/>
         * SmartFoxServer Basic / Pro</para>
		 ...
		 * <seealso cref="SmartFoxClient.SendXtMessage(string, string, ICollection, string, int)"/>
		 * 
		 * <remarks>
		 * <para><b>Version:</b><br/>
		 * SmartFoxServer Pro</para>
         ...
         * <seealso cref="SmartFoxClient.SendObjectToGroup(SFSObject, ArrayList, int)"/>
         * 
         * <remarks>
         * <para><b>Version:</b><br/>
         * SmartFoxServer Basic / Pro</para>
         ...
         * 
         * <seealso cref="Room"/>
         * <seealso cref="SmartFoxClient.SetRoomVariables(ArrayList, int, bool)"/>
         * 
         * <remarks>
         * <para><b>NOTE:</b><br/>
         ...
         * 
         * <seealso cref="User"/>
         * <seealso cref="SmartFoxClient.SetUserVariables(Hashtable, int)"/>
         * 
         * <remarks>
         * <para><b>NOTE:</b><br/>
         * the <c>changedVars</c> array contains the names of the changed variables only, not the actual values. To retrieve them the <see cref="User.GetVariable"/> / <see cref="User.GetVariables"/> methods can be used.</para>
         * <para><b>Version:</b><br/>
         * SmartFoxServer Basic / Pro</para>
         * </remarks>
         */
