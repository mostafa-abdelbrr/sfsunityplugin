...
namespace SmartFoxClientAPI.Data {
	...
	public class NewRoomDescriptor {
		...
		/**
		 * <summary>
		 * <see cref="NewRoomDescriptor(string, int, bool, int, ArrayList, ExtensionDescriptor, string, bool, bool)"/>
		 * </summary>
		 */
		public NewRoomDescriptor(string name, int maxUsers) : this(name, maxUsers, false, 0, new ArrayList(), null, "", true, false) { }
		/**
		 * <summary>
		 * <see cref="NewRoomDescriptor(string, int, bool, int, ArrayList, ExtensionDescriptor, string, bool, bool)"/>
		 * </summary>
		 */
		public NewRoomDescriptor(string name, int maxUsers, bool isGame) : this(name, maxUsers, isGame, 0, new ArrayList(), null, "", true, false) { }
		/**
		 * <summary>
		 * <see cref="NewRoomDescriptor(string, int, bool, int, ArrayList, ExtensionDescriptor, string, bool, bool)"/>
		 * </summary>
		 */
		public NewRoomDescriptor(string name, int maxUsers, bool isGame, int maxSpectators, ArrayList variables, ExtensionDescriptor extension) : this(name, maxUsers, isGame, maxSpectators, variables, extension, "", true, false) { }
		/**
		 * <summary>
		 ...
		 * <param name="variables">an ArrayList of Room Variables, as described in the <see cref="SmartFoxClient.SetRoomVariables(ArrayList, int, bool)"/> method documentation (optional, default: none).</param>
