...
namespace SmartFoxClientAPI.Data
{
    ...
    public class Buddy
    {
        ...
        /**
         * <summary><see cref="Buddy(int, string, bool, bool, Hashtable)"/></summary>
         */
        public Buddy(int id, string name, bool isOnline, bool isBlocked) : this(id, name, isOnline, isBlocked, new Hashtable()) { }
        /**
         * <summary>
         * Buddy constructor.
         * </summary>
